(* Warning/Note: original implementation has circuit ordering requirements for safety 
...
Definition aes_sbox_canright_masked_noreuse
  : kappa_sugared var << 
    (* TODO: input  aes_pkg::ciph_op_e op_i, *)
...
<[ \data_i in_mask_i out_mask_i =>
    ...
    let data_o = if op_i == CIPH_FWD
                 then !aes_mvm data_inverse !X2S ^ #63
                 then !aes_mvm data_inverse !X2A
